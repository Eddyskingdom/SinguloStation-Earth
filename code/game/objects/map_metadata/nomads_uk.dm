...
/obj/map_metadata/nomads_uk/New()
	..()
	spawn(18000)
		seasons()

/obj/map_metadata/nomads_uk/cross_message(faction)
	return ""

/obj/map_metadata/nomads_uk/job_enabled_specialcheck(var/datum/job/J)
	if (J.is_nomad == TRUE)
		. = TRUE
	else
		. = FALSE
